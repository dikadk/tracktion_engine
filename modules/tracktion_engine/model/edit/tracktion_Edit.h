...
*/
    ...
    */
        ...
        {
            jassert(trackCompManager != nullptr);
            return *trackCompManager;
        }
    ...
    */
        ...
        {
            jassert(masterVolumePlugin != nullptr);
            return masterVolumePlugin->volParam;
        }
        ...
        {
            jassert(masterVolumePlugin != nullptr);
            return masterVolumePlugin->panParam;
        }
